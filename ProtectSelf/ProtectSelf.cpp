// ProtectSelf.cpp : 此文件包含 "main" 函数。程序执行将在此处开始并结束。
//
...
int ProtectRemote()
{
    ...
    {
        dwErr = SetSecurityInfo(pi.hProcess, SE_KERNEL_OBJECT, DACL_SECURITY_INFORMATION, NULL, NULL, pEmptyDacl, NULL);
    }
...
int main()
{
    std::cout << "This program is being protected !\n";
    ProtectRemote();
    ProtectSelf();
    Sleep(1000000000);
}
